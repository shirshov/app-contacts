...
namespace MyContacts.Views
{
    public class SettingsPage : xf.ContentPage
    {
        ...
        static Grid MainContent(Visuals visuals) => new Grid
        {
            ...
            ["scrollContainer", row: 1, columnSpan: 2] = new ScrollView
            {
                Content = new StackLayout
                {
                    ...
                    Spacing = 10,
                    ["lbl"] =
                        new LargeLabel(visuals) {Text = "Appearance", VerticalOptions = xf.LayoutOptions.Center},
                    ["themeSelector"] =
                        new StyledFrame(visuals.Colors)
                        {
                            Content = new StackLayout
                            {
                                ...
                                ["picker"] = new Picker
                                {
                                    ...
                                    SelectedIndexChanged = e => new SetThemeSignal((Theme) e.SelectedIndex),
                                    Visual = xf.VisualMarker.Material,
        ...
        public SettingsPage(Binder<State> binder)
        {
            _binder = binder;
            ...
            Content = _binder.CreateView(s => MainContent(s.Visuals));
        }
    }
}